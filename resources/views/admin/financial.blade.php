...
function printInvoice(data) {
    ...
    document.getElementById('inv-reste-row').style.display = (data.reste > 0) ? 'flex' : 'none';
    ...
    // ← REMPLACÉ : window.print() → choosePrintFormat
    choosePrintFormat();
}
...
window.addEventListener('load', function () {
    try {
        ...
        if (data && data.printAfter) {
            ...
            // ← REMPLACÉ : appel direct → choosePrintFormat avec callback
